...
LLM_PROVIDER = os.environ.get("LLM_PROVIDER", "openai")  # Options: openai, anthropic, bedrock, or mock
LLM_MODEL = os.environ.get("LLM_MODEL", "gpt-4-turbo-preview")  # For OpenAI: gpt-4-turbo-preview, gpt-3.5-turbo; For Anthropic: claude-3-opus-20240229, claude-3-sonnet-20240229; For Bedrock: anthropic.claude-3-sonnet-20240229-v1:0, anthropic.claude-v2
...
# AWS Bedrock Configuration (only required when LLM_PROVIDER=bedrock)
AWS_BEDROCK_REGION = os.environ.get("AWS_BEDROCK_REGION", "us-east-1")  # AWS region where Bedrock is available
AWS_ACCESS_KEY_ID = os.environ.get("AWS_ACCESS_KEY_ID", "")  # AWS access key for Bedrock
AWS_SECRET_ACCESS_KEY = os.environ.get("AWS_SECRET_ACCESS_KEY", "")  # AWS secret key for Bedrock
